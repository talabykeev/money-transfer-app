...
INSERT INTO transactions (amount, transaction_id, user_id) VALUE (100, 'transaction-1', 1);
INSERT INTO transactions (amount, transaction_id, user_id) VALUE (200, 'transaction-2', 2);
